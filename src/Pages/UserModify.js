        ...
        <main className="bg-gray-200 min-h-screen p-5">
            ...
            <div className="max-w-7xl mx-auto">
                    <section className="card max-w-md">
                        ...
                        <button className="btn bg-white text-blue-500 border-2 border-blue-500 block mx-auto hover:bg-blue-500 hover:text-white"><i class="las la-camera-retro"></i> Cambiar foto</button>
                    </section>
                    <section className="card max-w-md">
                        ...
                        <form onSubmit={handleSubmit}>
                            ...
                            <button type="submit" className="bg-blue-500 text-white text-lg font-bold w-full py-2 mt-5 cursor-pointer hover:bg-blue-600"><i class="las la-save"></i> Guardar cambios</button>
                        </form>
                    </section>
            </div>
        </main>
